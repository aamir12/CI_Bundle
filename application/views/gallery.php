...
?>
  ...
  <h2><?php echo ($action=='add')?'Add':'Edit' ;?> Gallery <a href="<?= ROOTURL.'gallery'?>" class="btn btn-primary pull-right">
 Back
 </a></h2>
...
{
?>
 <h2>Gallery <a href="<?= ROOTURL.'gallery/add'?>" class="btn btn-primary pull-right">
 Add Image
 </a></h2>
